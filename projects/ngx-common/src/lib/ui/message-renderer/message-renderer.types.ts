...
export interface BarChartSection      { type: 'bar_chart';     title?: string; unit?: string; format?: string; orientation?: string; groups?: string[]; data: BarChartItem[]; }
...
export interface SuggestedPromptsSection { type: 'suggested_prompts'; title?: string; prompts?: string[]; prompt?: string[]; }
